...
class ScreenRefrigeracion extends StatefulWidget {
  @override
  _screenRefrigeracionState createState() => _screenRefrigeracionState();
}

class _screenRefrigeracionState extends State<ScreenRefrigeracion> {
  ...
  getDataProfesional() async{
    return await Firestore.instance.collection('register').where('orientacion',isEqualTo: 'refrigeracion').getDocuments();
  }
  _openPopup(context) {
    showDialog(
      context: context,
